...
if(!$validate->validateName($name)) {
    echo json_encode(["error"=> "É obrigatório fornecer um nome com 3 a 50 caracteres"]);
    die();
}

if(!$validate->validatePassword($password)) {
    echo json_encode(["error"=> "É obrigatório fornecer uma senha com 6 a 20 caracteres"]);
    die();
}
...
{
    echo json_encode(["success"=> "Usuário salvo com sucesso"]);
    die();
} else {
